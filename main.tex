...
\parbox[t]{0.75\textwidth}{
	{\centering
			\textbf{Software developer} and \textbf{computer science} student in
			Ottawa with several years of experience and a passion for learning
			new things, programming, and computers in general.
			\par
		}
}
\par
...
\experience{University of Ottawa}[Honours Bachelor of Science in
	\textbf{Computer Science}][\nth{4} Year (Graduation December 2024)]
